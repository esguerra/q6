...
separated by less than 2.1 �, the program will ask whether to add a bond or not.\\
\hline
\end{longtable}
...
solvent heavy atoms when adding solvent & 2.4 � \\
\hline \bf{solute\_density} & number density of solute & 0.05794 �$^{-3}$ \\
\hline \bf{max\_xlink} & upper limit of bond length when searching
for possible cross-link bonds & 2.1 � \\
...
\hline solute\_solute & Cut-off radius (�) for solute-solute atom pairs. & Optional, default 10 �.\\
\hline solvent\_solvent & Cut-off radius (�) for solvent-solvent. & Optional, default 10 �.\\
\hline solute\_solvent & Cut-off radius (�) for solute-solvent. & Optional, default 10 �.\\
\hline q\_atom & Cut-off radius (�) for Q-atoms interaction with all atoms. & Optional, default 99 �, \emph{$i.e.$} no cut-off. If PBC used, compare to boxlength.\\
\hline lrf & Cut-off radius (�) for LRF expansion. & Optional, default 99 �, \emph{$i.e.$} no cut-off.\\
\hline
\multicolumn{3}{p{394pt}}{}\\
...
\bibitem{Hansson:1998}Hansson, T., Marelius, J. and �qvist, J., Ligand Binding Affinity
...
\bibitem{Brunger:1984}Br�nger, A. T., Brooks, C.L. III. and Karplus, M., Stochastic Boundary Conditions for
...
\bibitem{Kolmodin:}Kolmodin, K. and �qvist, J, PTP proton transfer...

\bibitem{Aaqvist:1991}�qvist, J., Free Energy Perturbation Study of Metal Ion Catalyzed Proton Transfer in Water. J. Phys. Chem. 1991, 95,
4587-4590.

\bibitem{Wennerstroem} http://www.ibg.uu.se/upload/PetraW.pdf Wennerstr�m, P. (valid link
2003-06).
...
\bibitem{Gunsteren:1996} van Gunsteren, W.F., Billeter, S.R., Eising, A.A., H�nenberger, P.H., Kr�ger, P., Mark, A.E. and Tironi, I.G., Biomolecular Simulation: The GROMOS96 Manual and User Guide. Hochschulverlag AG an der ETH Z�rich,
1996.
